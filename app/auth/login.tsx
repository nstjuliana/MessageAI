    ...
    >
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Log in to continue to MessageAI</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          {/* TEST USER LOGIN BUTTON REMOVE BEFORE PRODUCTION */}
          <Pressable
            style={({ pressed }) => [
              styles.button,
              loading && styles.buttonDisabled,
            ...
            onPress={() => void signIn('test@test.com', 'test123').then(() => router.replace('/(authenticated)/chats'))}
            disabled={loading}
          >
            {loading ? (
              <ActivityIndicator color="#fff" />
          ...
          <View style={styles.footer}>
            ...
            <Pressable onPress={goToSignUp} disabled={loading}>
